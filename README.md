...
## Открываем терминал и установим все необходимые пакеты для сборки
    sudo apt-get update
...
## приступим к сборке модуля ядра.
...
## Теперь приступим к сборке openpvn
...
## Проверяем, если у вас GUI то закрываем и открываем новый терминал и вводим команду
    openvpn --version
